...
const DEFINITE_REJECTIONS = new Map<number, string>([
  ...
  // the request can execute. Absent from this map they fell to the ambiguous
  // default: safe, but it produced a permanently unresolvable UNKNOWN for a
  // request the server had definitively declined.
